...
// Keep native splash screen visible until we are ready
...
export default function App() {
  ...
  useEffect(() => {
    async function initialize() {
      try {
        // Run notification setup and data loading in parallel
        await Promise.all([
  ...
  async function registerForPushNotificationsAsync() {
    ...
    // Fix for Android 8.0+ Importance
  ...
  // While initializing, return null to keep the native splash screen visible
