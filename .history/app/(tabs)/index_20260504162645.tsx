      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.historyBox}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.remainingText}>{goal - water}ml left</Text>
          </View>
          
          {history.length === 0 ? (
            <View style={styles.emptyContainer}>
               <Feather name="info" size={16} color="#74777F" />
               <Text style={styles.emptyText}>Start drinking to log history</Text>
            </View>
          ) : (
            history.map((item) => (
